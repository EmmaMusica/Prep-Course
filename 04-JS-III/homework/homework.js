...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  let array = [];
  for(let i in arguments) array.push(arguments[i])
...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  let count = 0
  arreglo.forEach( e => { if(e > 18) count++ } )
  return count
}
...
function todosIguales(arreglo) {
  ...
  if(arreglo[i] !== arreglo[i + 1]) bandera = false
  return bandera
...
function mesesDelAño(array = []) {
  ...
  // Tu código:
  let newArr = array.filter( e => e === 'Enero' || e === 'Marzo' || e === 'Noviembre')
